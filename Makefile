...
check-install-sh: ## install.sh と kit 補助スクリプト (bin/) を shellcheck (shellcheck 必須)
	@shellcheck -S warning install.sh bin/*.sh && echo "ok  install.sh + bin/*.sh (shellcheck)"
